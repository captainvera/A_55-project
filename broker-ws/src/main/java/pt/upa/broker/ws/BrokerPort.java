...
public class BrokerPort implements BrokerPortType{
  ...
  public BrokerPort(boolean primary, String url) throws Exception{
    ...
    if(primary){
      ...
      connectToBroker();
      if(_broker != null){
        System.out.println("Sending my URL " + _url + "to the primary broker");
